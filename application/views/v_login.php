                ...
                <div class="col-lg-8 col-md-12 col-sm-9 col-xs-12 form-box text-center">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="row mb-3">
                            <div class="col-6 d-flex">
                                <div class="custom-control customcheckbox">
                                    ...
                                    <label for="" class="custom-control-label text-white" for="cb1"> Remember </label>
                                </div>
                            </div>
                            <div class="col-6 textright">
                                <a href="forget.php" class="forget-link">Lupa Password</a>
                            </div>
                        </div>
                        ...
                        <div class="text-center mb-2">
                            <div class="mb-3" style="color: #777">Atau login dengan</div>

                            <a href="" class="btn btn-social btn-facebook">Facebook</a>

                            <a href="" class="btn btn-social btn-google">Google</a>
                        </div>
                        <div style="color:#777">Tidak punya akun?
                            <a href="<?php echo base_url('index.php/dashboard/regis')?>" class="register-link">Register disini.</a>
                        </div>
                    </form>
                </div>
            </div>
