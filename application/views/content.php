...
<body>
	<div class="row no-gutters mt-5">
		...
		<h3><i class="fa fa-pencil-square-o mr-2 ml-4 " aria-hidden="true"><Font class="ml-2">Tulis Pengaduan </font></i></h3>
				...
				<div class="card-body">
					<form action="" class="form-horizontal">
						...
						<div class="form-group cols-sm-6">
							...
							<input type="file" name="foto" accept=".jpg, .jpeg, .png, .gif " value="" class="form-control">
